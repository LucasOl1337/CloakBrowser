...
**State:** active | Dirty entries: 2 | Ahead/Behind: +0 / -0
...
|--------|------------|-----------------|-------|
| HEAD | c32e9aa | c32e9aa | |
| Branch | main | origin/main | |
| Ahead / Behind | +0 | -0 | |
| Working tree | dirty (2 entries) | remote assumed clean | |
| Remote URL | https://github.com/LucasOl1337/CloakBrowser.git | | |
